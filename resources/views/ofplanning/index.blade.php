			...
			<div class="card">
				...
				<div class="card-body">
					<div class="d-flex justify-content-end mb-3">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ofModal">
							<i class="mdi mdi-plus"></i> Ajouter une commande
						</button>
					</div>
		...
		$(document).ready(function () {
			...
			$('#fabOrdersTable').DataTable({
				...
				columns: [
                    ...
                    <button class="btn btn-sm btn-danger delete-btn ml-1" data-id="${row.id}">
